/**
 * InformacionPersonalMinvuMatrimonio.java
 *
...
public class InformacionPersonalMinvuMatrimonio  extends cl.gob.aem.valida.DatosPersonalMinvuType  implements java.io.Serializable {
    private cl.gob.aem.valida.FechaType fechaInscripcionMatrimonio;

    private java.lang.String regimenConyugal;

    public InformacionPersonalMinvuMatrimonio() {
    }
    ...
    /**
     * Gets the fechaInscripcionMatrimonio value for this InformacionPersonalMinvuMatrimonio.
     * 
    ...
    /**
     * Sets the fechaInscripcionMatrimonio value for this InformacionPersonalMinvuMatrimonio.
     * 
    ...
    /**
     * Gets the regimenConyugal value for this InformacionPersonalMinvuMatrimonio.
     * 
    ...
    /**
     * Sets the regimenConyugal value for this InformacionPersonalMinvuMatrimonio.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InformacionPersonalMinvuMatrimonio)) return false;
        InformacionPersonalMinvuMatrimonio other = (InformacionPersonalMinvuMatrimonio) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InformacionPersonalMinvuMatrimonio.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://valida.aem.gob.cl", ">>informacionPersonalMinvu>matrimonio"));
